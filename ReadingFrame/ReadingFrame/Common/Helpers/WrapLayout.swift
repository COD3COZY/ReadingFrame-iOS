...
//    /// 각 줄에 몇개씩 몇 줄이 있는지 알 수 있는 배열
//    @Binding private(set) var rowCounts: [Int]
...
//        self.rowCounts = rows.map { row in
//            row.count
//        }
//        print("row counts: \(String(describing: self.rowCounts))")
